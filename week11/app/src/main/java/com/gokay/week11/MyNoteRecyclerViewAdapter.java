...
import com.gokay.week11.PlaceholderContent.PlaceholderItem;
import com.gokay.week11.databinding.FragmentNoteBinding;
...
public class MyNoteRecyclerViewAdapter extends RecyclerView.Adapter<MyNoteRecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mDateView.setText((new SimpleDateFormat("yyy-MM-dd")).format(notes.get(position).getDate()));
